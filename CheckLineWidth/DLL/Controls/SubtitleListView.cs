...
namespace Nikse.SubtitleEdit.PluginLogic.Controls
{
    internal sealed class SubtitleListView : ListView
    {
        ...
        private string _lineSeparatorString = "<br />";
        ...
        {
            Columns[ColumnIndexStart].Text = "Start";
            Columns[ColumnIndexEnd].Text = "End";
            Columns[ColumnIndexDuration].Text = "Duration";
            Columns[ColumnIndexText].Text = "Text";
        ...
        internal void SelectIndexAndEnsureVisible(Paragraph p)
        {
            SelectNone();
            if (p == null)
                return;
        ...
        internal Paragraph GetSelectedParagraph(Subtitle subtitle)
        {
        ...
        internal void SetTimeAndText(int index, Paragraph paragraph)
        {
            if (index >= 0 && index < Items.Count)
            {
        ...
        internal void SetDuration(int index, Paragraph paragraph)
        {
            if (index >= 0 && index < Items.Count)
            {
                ListViewItem item = Items[index];
        ...
        internal void SetStartTime(int index, Paragraph paragraph)
        {
            if (index >= 0 && index < Items.Count)
            {
                ListViewItem item = Items[index];
        ...
        internal void SetStartTimeAndDuration(int index, Paragraph paragraph)
        {
            if (index >= 0 && index < Items.Count)
            {
                ListViewItem item = Items[index];
