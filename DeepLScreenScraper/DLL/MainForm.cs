...
namespace WebViewTranslate
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            linkLabel1.Text = new DeepLScreenScraper.Translator.DeepLScreenScraper(null, null, null).GetName();
        }

        private void SetLanguages(ComboBox comboBox, string language)
        {
            comboBox.Items.Clear();
            foreach (var pair in DeepLScreenScraper.Translator.DeepLScreenScraper.GetTranslationPairs())
            {
        ...
        private void Translate(string source, string target, DeepLScreenScraper.Translator.DeepLScreenScraper translator, int maxTextSize, int maximumRequestArrayLength = 100)
        {
        ...
        private void buttonTranslate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Translate(_from, _to, new DeepLScreenScraper.Translator.DeepLScreenScraper(_webView, _from, _to), (int)numericUpDownMaxBytes.Value);
            }
            finally
            {
                buttonTranslate.Enabled = true;
