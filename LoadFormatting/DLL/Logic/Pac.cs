...
namespace Nikse.SubtitleEdit.PluginLogic
{
    ...
    {
        public int PacVerticalTop { get; set; } = 1;
        public int PacVerticalCenter { get; set; } = 5;
        public int PacVerticalBottom { get; set; } = 11;
        ...
        internal override string Extension => ".pac";
        internal override bool IsTimeBased { get; } = true;

        public virtual bool IsFpc { get; set; }

        public const string NameOfFormat = "PAC (Screen Electronics)";

        internal override string  Name => NameOfFormat;
        ...
        private void WriteParagraph(Stream fs, Paragraph p, int number, bool isLast)
        {
            ...
            var verticalAlignment = (byte)Math.Max(0, PacVerticalBottom + 1 - Utilities.GetNumberOfLines(p.Text));
            ...
            {
                verticalAlignment = (byte)PacVerticalTop; // top
            }
            ...
            {
                verticalAlignment = (byte)PacVerticalCenter; // center
            }
        ...
        private Paragraph GetPacParagraph(ref int index, byte[] buffer, bool usesSecondaryCodePage, int paragraphIndex)
        {
            ...
            p.Text = Utilities.RemoveControlCharactersButWhiteSpace(p.Text).TrimEnd();
            return p;
        }
        ...
        internal static TimeCode GetTimeCode(int timeCodeIndex, byte[] buffer)
        {
            ...
            return new TimeCode(TimeSpan.Zero);
        }
