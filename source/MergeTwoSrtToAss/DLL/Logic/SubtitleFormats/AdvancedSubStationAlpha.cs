...
namespace Nikse.SubtitleEdit.PluginLogic.Logic.SubtitleFormats
{
    public class AdvancedSubStationAlpha : SubtitleFormat
    {
        ...
        public static string DefaultStyle
        {
            get
            {
                ...
                return "Style: Default,Arial,20," +
                    GetSsaColorString(Color.White) + "," +
                    "&H0300FFFF,&H00000000,&H02000000,0,0,0,0,100,100,0,0," + borderStyle + ",2,1,2,10,10,10,1";
            }
        }
