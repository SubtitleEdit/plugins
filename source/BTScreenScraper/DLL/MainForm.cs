    ...
    public partial class MainForm : Form
    {
        ...
        private void buttonTranslate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Translate(_from, _to, new BingTranslateScreenScraper(_webBrowser, _from, _to), (int)numericUpDownMaxBytes.Value);
            }
            finally
            {
                buttonTranslate.Enabled = true;
        ...
        private string GetSettingsFileName()
        {
            ...
            return Path.Combine(path, "BingScreenScraperTranslate.xml");
        }
