...
namespace SubtitleEdit.Logic
{
    public class AdvancedSubStationAlpha : SubtitleFormat
    {
        ...
        public bool HasStyleSupport => true;

        internal override string Extension => ".ass";

        public const string NameOfFormat = "Advanced Sub Station Alpha";

        internal override string Name => NameOfFormat;

        internal override bool IsTimeBased => true;
...
[Events]");
                ...
                else if (eventsStarted)
                {
                    ...
                    else if (!string.IsNullOrEmpty(s))
                    {
                        ...
                        catch
                        {
                            ...
                            {
                                errors.AppendLine("Too many errors");
                            }
        ...
        public static string GetSsaColorStringForEvent(Color c)
        {
            ...
            return $"\\c&H{c.B:X2}{c.G:X2}{c.R:X2}&\\1a&H{alpha:X2}&";
        }
