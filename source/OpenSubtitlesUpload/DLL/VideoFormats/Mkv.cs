...
namespace OpenSubtitlesUpload.VideoFormats
{
    ...
    internal class SubtitleSequence
    {
        internal long StartMilliseconds { get; set; }
        internal long EndMilliseconds { get; set; }
        internal byte[] BinaryData { get; set; }

        internal SubtitleSequence(byte[] data, long startMilliseconds, long endMilliseconds)
        {
            BinaryData = data;
    ...
    internal class MatroskaSubtitleInfo
    {
        internal long TrackNumber { get; set; }
        internal string Name { get; set; }
        internal string Language { get; set; }
        internal string CodecId { get; set; }
        internal string CodecPrivate { get; set; }
        internal int ContentCompressionAlgorithm { get; set; }
        internal int ContentEncodingType { get; set; }
    }
    ...
    internal class MatroskaTrackInfo
    {
        ...
        internal bool IsVideo { get; set; }
        internal bool IsAudio { get; set; }
        internal bool IsSubtitle { get; set; }
        internal string CodecId { get; set; }
        internal string CodecPrivate { get; set; }
        internal int DefaultDuration { get; set; }
        internal string Language { get; set; }
    }
    ...
    internal class Mkv : IDisposable
    {
        ...
        internal delegate void LoadMatroskaCallback(long position, long total);
        ...
        private struct ByteLayout16
        {
            ...
            [System.Runtime.InteropServices.FieldOffset(0)]
            internal Int16 IntData16; //16-bit signed int
        }
        ...
        private struct FloatLayout32
        {
            ...
            [System.Runtime.InteropServices.FieldOffset(0)]
            internal Single FloatData32; //32-bit

            [System.Runtime.InteropServices.FieldOffset(0)]
            internal UInt32 UintData32; //32-bit
        }
        ...
        private struct FloatLayout64
        {
            ...
            [System.Runtime.InteropServices.FieldOffset(0)]
            internal Double FloatData64; //64-bit
        }
        ...
        internal List<MatroskaTrackInfo> GetTrackInfo()
        {
            byte b;
            bool done;
            UInt32 matroskaId;
        ...
        internal Int64 GetTrackStartTime(int trackNumber)
        {
            byte b;
            bool done;
            UInt32 matroskaId;
        ...
        internal void GetMatroskaInfo(string fileName,
                                   ref bool isValid,
        ...
        internal List<MatroskaSubtitleInfo> GetMatroskaSubtitleTracks(string fileName, out bool isValid)
        {
            byte b;
            bool done;
            UInt32 matroskaId;
        ...
        internal List<SubtitleSequence> GetMatroskaSubtitle(string fileName, int trackNumber, out bool isValid, LoadMatroskaCallback callback)
        {
            byte b;
            bool done;
            UInt32 matroskaId;
