...
using PromptTranslate.Translator;
...
namespace WebViewTranslate
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            linkLabel1.Text = new PromptTranslator(null, null).GetName();
        }

        private void SetLanguages(ComboBox comboBox, string language)
        {
            comboBox.Items.Clear();
            foreach (var pair in PromptTranslator.GetTranslationPairs())
            {
            ...
            : this()
        {
            ...
            GeneratePreview();
            RestoreSettings();
            var languages = PromptTranslator.GetTranslationPairs().Select(p=>p.Code).ToList();
        ...
        private void Translate(string source, string target, PromptTranslator translator, int maxTextSize, int maximumRequestArrayLength = 100)
        {
        ...
        {
            Process.Start(new PromptTranslator(null, null).GetUrl());
        }
        ...
        private void buttonTranslate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Translate(_from, _to, new PromptTranslator(_from, _to), (int)numericUpDownMaxBytes.Value);
            }
            finally
            {
                buttonTranslate.Enabled = true;
        ...
        private string GetSettingsFileName()
        {
            ...
            return Path.Combine(path, "DeepLScraperTranslate.xml");
        }
