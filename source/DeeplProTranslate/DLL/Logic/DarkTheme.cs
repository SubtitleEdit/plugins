...
namespace Nikse.SubtitleEdit.PluginLogic
{
    public static class DarkTheme
    {
        ...
        public static Color ForeColor => Color.FromArgb(155, 155, 155);
        public static Color DarkThemeDisabledColor => Color.FromArgb(120, 120, 120);
        ...
        private class MyRenderer : ToolStripProfessionalRenderer
        {
            ...
            protected override void OnRenderItemCheck(ToolStripItemImageRenderEventArgs e)
            {
                ...
                {
                    g.DrawImageUnscaled(Resources.tick, new Point(e.ImageRectangle.Left, e.ImageRectangle.Top));
                }
            }
